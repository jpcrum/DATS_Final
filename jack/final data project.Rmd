...
df[index.garage.type, 'garage.type'] <- 'No Garage'

index.garage.finish <- which(is.na(df$garage.finish))
df[index.garage.finish, 'garage.finish'] <- 'No Garage'

index.garage.qual <- which(is.na(df$garage.qual))
df[index.garage.qual, 'garage.qual'] <- 'No Garage'

index.garage.cond <- which(is.na(df$garage.cond))
df[index.garage.cond, 'garage.cond'] <- 'No Garage'
```
